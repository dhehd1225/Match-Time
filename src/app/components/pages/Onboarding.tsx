    ...
    <div className="min-h-screen bg-gray-50 p-6 flex flex-col justify-center">
      ...
      <div className="grid gap-4">
        ...
        <button 
          ...
          className="bg-white p-6 rounded-2xl shadow-sm border-2 border-transparent hover:border-red-500 transition-all text-left">
          <Search className="text-red-600 mb-3" size={32} />
          <h3 className="font-bold text-lg text-gray-900">팀 가입하기</h3>
